...
document.getElementById("creditCardForm").addEventListener("submit", function (event) {
    ...
    {
      document.getElementById("innerTextOutput").innerText="Tu tarjeta de crédito " +validator.creditCardType(creditCardNumber)+"\nNº "+validator.maskify(creditCardNumber)+"\nes válida"; 
